...
int main()
{
    ...
    // link shaders into shader program object
    // output of vertex shader is input of fragment shader
    ...
    // Vertex Buffer Object to hold vertices info
    // Vertex Array Object for easy vertex attribute storage and access
    unsigned int VBO, VAO;
    glGenVertexArrays(1, &VAO); // only want 1 vertex array object generated
    glGenBuffers(1, &VBO); // only want 1 buffer object generated

    // By binding VAO, it will store
    ...
    // So after doing calls/bindings 1) to 3), we should unbind VAO for later use,
    // then bind again when we want to render.
    glBindVertexArray(VAO);

    // By binding buffer, any buffer calls we make (on the GL_ARRAY_BUFFER target)
   ...
   glBindVertexArray(0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawArrays(GL_TRIANGLES, 0, 3); // start index = 0, total vertices = 3
